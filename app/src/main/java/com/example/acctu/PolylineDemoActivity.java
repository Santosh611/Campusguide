...
import static com.example.acctu.utils.CheckUtils.checkIsEdit;
import static com.example.acctu.utils.CheckUtils.checkIsRight;
...
//        points.add(MapUtils.FRANCE2);
//        points.add(MapUtils.FRANCE3);
    }
    ...
    public void addPolyline(View view) {
        ...
        mPolyline = hMap.addPolyline(
            new PolylineOptions().add(MapUtils.krct, MapUtils.source)
                .color(Color.BLUE)
                .width(3));
    ...
    public void removePolyline(View view) {
        ...
        points.clear();
        points.add(MapUtils.krct);
        points.add(MapUtils.source);
    }
