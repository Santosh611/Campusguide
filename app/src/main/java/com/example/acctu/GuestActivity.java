...
//        ActivityCompat.requestPermissions(GuestActivity.this, new String[] {Manifest.permission.CAMERA}, requestCode);
...
//                .setMaskColor(getResources().getColor(R.color.greenTransparent))//THIS SHOULD BE UNIQUE ID
        ...
        buttoncont.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(GuestActivity.this);
...
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(GuestActivity.this, ScannerActivity.class);
...
//                builder.setMessage("Use us to scan QRs present around the campus to get more info");
//                builder.show();
//                return false;
//            }
//
//        });
        ...
        buttonLoc.setOnLongClickListener(new View.OnLongClickListener(){
            @Override
            public boolean onLongClick(View v){
                Intent intent = new Intent(GuestActivity.this, MapsActivity.class);
                startActivity(intent);
                return false;
        ...
        buttondep.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GuestActivity.this, DepartmentsActivity.class);
                startActivity(intent);
            }
        });
